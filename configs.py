...
class Config(object):
	API_ID = int(os.environ.get("API_ID", "21427459"))
	API_HASH = os.environ.get("API_HASH", "cb23f6f9c4fe9783a0d948c7e2178d26")
	BOT_TOKEN = os.environ.get("BOT_TOKEN", "6693408130:AAHbVnan66tqlBXhUt2fS9nWsBIXtUlVVP0")
	BOT_USERNAME = os.environ.get("BOT_USERNAME", "Anu_file_store_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1001811770012"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "876726277"))
	DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Venkeycharan1143:Venkeycharan1143@cluster0.hetydxe.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001529448060")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001811770012")
